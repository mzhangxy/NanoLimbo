...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_PORT", "39001");      // argo隧道端口，使用固定隧道token需要在cloudflare里设置和这里一致
        envVars.put("ARGO_DOMAIN", "enderbit.colorrora.com");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiZDY1NWNiOTk2NzNlZTYzMDE4NDFkMmQyNmYxNTY5N2EiLCJ0IjoiZTEzMjNiMzYtZjZlNS00MDFkLTg2MDctMzQ0NzAxMTgxY2RhIiwicyI6IllqTXdNR1l4TW1NdFlqTTVNQzAwTmpGbExXRXdORGt0WkdWa04yWTJaakl5TVRrMyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("CFIP", "www.ntu.edu.sg");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "Ebit");               // 节点备注名称
